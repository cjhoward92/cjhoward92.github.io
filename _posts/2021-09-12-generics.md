...
I think the difficulty in generics comes from bad type variable naming or overly complex types. You usually see type variables n1ames `T` or `U` (like in my example above).
